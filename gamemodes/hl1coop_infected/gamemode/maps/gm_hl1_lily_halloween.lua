...
function MAP:ModifyMapEntities()
	...
	if IsValid(michaledavvie) then
		michaledavvie:SetPos(Vector(3673.177979,185.366074,256.031311))
	...
	CreateBarrel(Vector(2926.2563476563, 3449.7534179688, 32.370956420898), math.random(5,10))
	CreateBarrel(Vector(2913.4692382813, 3389.7409667969, 32.412414550781), math.random(5,10))
	...
	CreateBarrel(Vector(2686.117188, 1423.362915, 348.031250), math.random(30,35), Angle(0, 0, 90))
	// Offices
	CreateBarrel(Vector(2144.8166503906, 1012.2333984375, 112.48658752441), math.random(5,15))
	// Boiler Room and Mine
	...
	CreateBarrel(Vector(3193.345703125, 5486.603515625, 21.940551757813), math.random(5,10), Angle(0, 0, 90))
	// Abandoned Offices
	CreateBarrel(Vector(1864.2143554688, 4529.408203125, 64.28125), math.random(5,10))
	CreateBarrel(Vector(1859.8726806641, 4601.4223632813, 64.281257629395), math.random(5,10))
	CreateBarrel(Vector(2383.6896972656, 4819.2719726563, 64.281257629395), math.random(5,10))
	CreateBarrel(Vector(2391.4567871094, 4880.2387695313, 64.43563079834), math.random(5,10))
	CreateBarrel(Vector(2392.9252929688, 4941.9609375, 64.28125), math.random(5,10))
	CreateBarrel(Vector(1870.4594726563, 4893.3681640625, 64.28125), math.random(5,10))
	CreateBarrel(Vector(1862.8728027344, 4816.7646484375, 64.28125), math.random(5,10))
	CreateBarrel(Vector(2167.3193359375, 4760.3872070313, 272.44964599609), math.random(5,10))
	CreateBarrel(Vector(2111.5886230469, 4766.5634765625, 272.40405273438), math.random(5,10))
	CreateBarrel(Vector(2133.1733398438, 5071.6752929688, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2089.0046386719, 5120.2397460938, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2047.9669189453, 5163.0151367188, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2012.9548339844, 5211.6323242188, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2206.9528808594, 5256.3481445313, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2282.619140625, 5243.0698242188, 272.28125), math.random(5,10))
	CreateBarrel(Vector(2939.7221679688, 4514.9404296875, 272.44125366211), math.random(5,10))
	CreateBarrel(Vector(2889.7170410156, 4523.5776367188, 272.42233276367), math.random(5,10))
	CreateBarrel(Vector(2836.8034667969, 4522.0390625, 272.43612670898), math.random(5,10))
	CreateBarrel(Vector(2783.2741699219, 4525.2783203125, 272.4700012207), math.random(5,10))
	CreateBarrel(Vector(2920.6806640625, 4129.3833007813, 272.49700927734), math.random(5,10))
	CreateBarrel(Vector(2918.1247558594, 4291.7529296875, 272.49978637695), math.random(5,10))
	CreateBarrel(Vector(2872.6728515625, 4326.9155273438, 272.49978637695), math.random(5,10))
	// Church Area Outside
	...
	CreateBarrel(Vector(3410.4814453125, 678.54278564453, 224.42781066895), math.random(5,10))
	CreateBarrel(Vector(3408.6264648438, 735.86614990234, 224.49980163574), math.random(5,10))
	CreateBarrel(Vector(3149.2473144531, 734.75311279297, 224.47836303711), math.random(5,10))
	CreateBarrel(Vector(3150.8171386719, 677.20220947266, 224.48756408691), math.random(5,10))
	...
	CreateBarrel(Vector(3757.8640136719, 9243.8876953125, -7391.6538085938), math.random(10,15))
	CreateBarrel(Vector(3756.7922363281, 9185.9306640625, -7391.6000976563), math.random(10,15))
	CreateBarrel(Vector(3302.8752441406, 9642.8837890625, -7391.6459960938), math.random(10,15))
	CreateBarrel(Vector(3354.0974121094, 9645.1708984375, -7391.5776367188), math.random(10,15))
	CreateBarrel(Vector(2698.0551757813, 9315.3408203125, -7327.71875), math.random(10,15))
	-- CreateBarrel(Vector(2698.0551757813, 9295.3408203125, -7327.71875), math.random(10,15))
	CreateBarrel(Vector(2751.0949707031, 9297.2109375, -7327.71875), math.random(10,15))
	CreateBarrel(Vector(2515.9453125, 9477.3740234375, -7327.71875), math.random(10,15))
	CreateBarrel(Vector(2519.2219238281, 9532.564453125, -7327.71875), math.random(10,15))
	CreateBarrel(Vector(2443.3801269531, 9892.0751953125, -7263.71875), math.random(10,15))
	CreateBarrel(Vector(2440.2963867188, 9947.3388671875, -7263.71875), math.random(10,15))
	CreateBarrel(Vector(2683.2255859375, 10737.953125, -7039.71875), math.random(10,15))
	CreateBarrel(Vector(2625.3981933594, 10743.091796875, -7039.71875), math.random(10,15))
	CreateBarrel(Vector(1794.0731201172, 10995.50390625, -6911.71875), math.random(10,15))
	CreateBarrel(Vector(1851.0379638672, 10996.262695313, -6911.71875), math.random(10,15))
	CreateBarrel(Vector(1798.1772460938, 10325.333984375, -6911.71875), math.random(10,15))
	CreateBarrel(Vector(1850.9223632813, 10329.447265625, -6911.71875), math.random(10,15))
	// Main Area
	CreateBarrel(Vector(2776.9291992188, 10710.875976563, -6783.59375), math.random(10,15))
	CreateBarrel(Vector(2721.5744628906, 10712.282226563, -6783.546875), math.random(10,15))
	CreateBarrel(Vector(2665.69921875, 10717.690429688, -6783.5473632813), math.random(10,15))
	CreateBarrel(Vector(2614.8669433594, 10719.263671875, -6783.5668945313), math.random(10,15))
	CreateBarrel(Vector(2719.2919921875, 9342.46484375, -6783.5375976563), math.random(10,15))
	CreateBarrel(Vector(4196.9438476563, 9339.9072265625, -6783.5341796875), math.random(10,15))
	CreateBarrel(Vector(4198.3212890625, 9389.11328125, -6783.5004882813), math.random(10,15))
	CreateBarrel(Vector(4197.0522460938, 9438.826171875, -6783.552734375), math.random(10,15))
	CreateBarrel(Vector(3868.6987304688, 10529.676757813, -6783.6357421875), math.random(10,15))
	CreateBarrel(Vector(2914.3352050781, 10529.889648438, -6783.5854492188), math.random(10,15))
	CreateBarrel(Vector(2912.4592285156, 9953.5654296875, -6783.6513671875), math.random(10,15))
	CreateBarrel(Vector(3872.2463378906, 9953.365234375, -6783.6484375), math.random(10,15))
	// Bone Pile
	CreateBarrel(Vector(4957.94921875, 9367.876953125, -6783.6391601563), math.random(10,15))
	CreateBarrel(Vector(4904.2319335938, 9365.6572265625, -6783.6206054688), math.random(10,15))
	//
	CreateBarrel(Vector(4911.1865234375, 10724.53125, -6783.5112304688), math.random(10,15))
	CreateBarrel(Vector(4960.1791992188, 10721.536132813, -6783.5625), math.random(10,15))
	CreateBarrel(Vector(4967.0610351563, 10672.543945313, -6783.609375), math.random(10,15))
	CreateBarrel(Vector(4032.1892089844, 10720.916015625, -6783.7358398438), math.random(10,15))
	// Exit Portal Room
	...
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(2055.9946289063, 4305.9907226563, 254.21342468262), Angle(89.953186035156, -144.45150756836, 180))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(2105.1181640625, 4275.5024414063, 241.84509277344), Angle(0.88793325424194, 72.40202331543, 5.8262028694153))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(2053.8286132813, 4275.4975585938, 251.21801757813), Angle(24.781921386719, 65.795516967773, 27.24979019165))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/recorder_three.mdl", Vector(2025.6719970703, 4340.1411132813, 297.12020874023), Angle(0.0083532575517893, -32.968242645264, 0.20933423936367))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/recorder_two.mdl", Vector(2066.3725585938, 4442.4697265625, 285.79934692383), Angle(-56.885524749756, 115.79551696777, -0.68936157226563))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/wooden_desk.mdl", Vector(2156.5004882813, 4448.2504882813, 264.55917358398), Angle(-0.040043789893389, 47.930160522461, 82.996932983398))
	...
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/wooden_desk.mdl", Vector(2180.986328125, 4606.4956054688, 258.72717285156), Angle(0.00039757986087352, -89.615005493164, -0.59548950195313))
	...
	GAMEMODE:CreatePhysicsDecoration("models/props/portedprops3/chair.mdl", Vector(2185.9826660156, 4595.80078125, 291.79345703125), Angle(-0.59812092781067, 179.75880432129, -0.014556884765625))
	...
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/recorder_two.mdl", Vector(2002.4816894531, 4757.0854492188, 296.99899291992), Angle(-0.066295184195042, -0.44192126393318, -0.025115966796875))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/recorder_three.mdl", Vector(2001.6811523438, 4672.5336914063, 296.99722290039), Angle(6.5936895055074e-08, -0.24753268063068, -0.003509521484375))
	
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(1999.3780517578, 4618.921875, 240.26832580566), Angle(0.017968369647861, 0.42592141032219, 0.074319191277027))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(1999.6915283203, 4595.6928710938, 240.36973571777), Angle(0.0078342435881495, 0.086856499314308, 0.10128080099821))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(1999.4708251953, 4572.5703125, 240.36663818359), Angle(-0.0064866654574871, 0.010083113797009, 0.10618117451668))
	...
	GAMEMODE:CreatePhysicsDecoration("models/props/hl4props/metalbox01.mdl", Vector(2136.9187011719, 4595.4912109375, 256.49975585938), Angle(-8.2420010585338e-05, 176.73442077637, 0))
	GAMEMODE:CreatePhysicsDecoration("models/props/hl4props/metalbox01.mdl", Vector(2142.5993652344, 4665.23046875, 256.49609375), Angle(0.0053251790814102, 151.55767822266, -0.0052490234375))
	GAMEMODE:CreatePhysicsDecoration("models/props/hl4props/metalbox01.mdl", Vector(2142.86328125, 4634.0517578125, 291.86624145508), Angle(0.26941093802452, -91.508735656738, 8.4756555557251))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/wooden_desk.mdl", Vector(2823.9458007813, 4124.6147460938, 258.45953369141), Angle(-0.028022242709994, 177.3857421875, 0.051307488232851))
	GAMEMODE:CreatePhysicsDecoration("models/props/fifties/wooden_desk.mdl", Vector(2864.5593261719, 4704.43359375, 258.49224853516), Angle(-0.010269370861351, 0.1538901925087, -3))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(2928.3327636719, 4718.9985351563, 240.36834716797), Angle(0.083672031760216, -92.626525878906, -0.002197265625))
	GAMEMODE:CreatePhysicsDecoration("models/halflife/props/file_cabinet.mdl", Vector(2955.6843261719, 4718.947265625, 240.31823730469), Angle(0.0025823831092566, -94.666725158691, 0.40607488155365))
	...
	*/
		...
		-- Default Zombies
		// Offices Outside
		GAMEMODE:CreateZombieSpawner(Vector(2390.944580, 3022.607666, 64.068001), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2433.629883, 2122.903076, 64.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3235.016113, 2620.722168, 64.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2136.622314, 1436.394043, 10), Angle(), 10, 1)
		// Offices
		GAMEMODE:CreateZombieSpawner(Vector(2996.527100, 1523.994995, 84.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2513.736816, 1179.057007, 84.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2513.736816, 1614.435791, 80.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2384.626465, 1183.453369, 84.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3058.484375, 1253.220337, 70.031250), Angle(), 10, 1)
		// Vehicle Tunnel
		GAMEMODE:CreateZombieSpawner(Vector(3870.591797, 2605.938477, 0.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4332.046387, 2258.768311, 0.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4354.608887, 3436.380371, 0.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4335.038086, 2256.738037, 0.031250), Angle(), 10, 1)
		// Abandoned Offices Outside
		GAMEMODE:CreateZombieSpawner(Vector(4192.713379, 4874.968750, 0.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3395.019043, 4372.447754, 0.031250), Angle(), 10, 1)
		// Abandoned Offices
		GAMEMODE:CreateZombieSpawner(Vector(2355.584473, 4410.699707, 46.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(1692.188843, 4066.072754, 158.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2319.202881, 4409.510254, 254.031250), Angle(), 10, 1)
		// Church Outside
		GAMEMODE:CreateZombieSpawner(Vector(4529.850586, 1251.144775, 0.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(6244.919922, 1189.830688, 206.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(6486.012207, 175.280975, 206.031250), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(6475.668945, -893.354065, 307.364288), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(6036.860352, -868.889038, 301.251770), Angle(), 10, 1)
		GAMEMODE:CreateZombieSpawner(Vector(5369.437012, 181.950119, 208.031250), Angle(), 10, 1) // Parking Lot
		GAMEMODE:CreateZombieSpawner(Vector(4172.881348, 194.964142, 206.031342), Angle(), 10, 1) // Infront of Church
		GAMEMODE:CreateZombieSpawner(Vector(1937.267212, 169.444550, 206.031250), Angle(), 10, 1) // Behind Church
		// Church
		GAMEMODE:CreateZombieSpawner(Vector(2766.938477, 193.152130, 206.031250), Angle(), 10, 1)
		// Portal to HERESY
		GAMEMODE:CreateZombieSpawner(Vector(6813.631348, -2081.557861, 344.031250), Angle(), 10, 1)
		// HERESY
		GAMEMODE:CreateZombieSpawner(Vector(3537.548828, 8951.824219, -7420.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2719.767578, 9505.716797, -7350.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2642.456543, 10555.260742, -7067.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(1801.810791, 10711.543945, -6939.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2655.082031, 10556.724609, -7067.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2649.021729, 10449.067383, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(2794.906982, 9495.152344, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3199.390869, 10245.243164, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3015.751465, 10619.413086, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3009.863037, 9845.065430, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3653.265869, 10238.319336, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3778.140381, 10618.083008, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3782.743164, 9854.017578, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(3773.689697, 10606.888672, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4131.134766, 10622.812500, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4848.227539, 10567.101563, -6811.968750), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4631.407227, 9539.171875, -6772.512695), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4444.366699, 9552.232422, -6751.972656), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4434.746094, 9418.627930, -6754.395508), Angle(), 3, 1)
		GAMEMODE:CreateZombieSpawner(Vector(4618.332520, 9420.189453, -6766.551758), Angle(), 3, 1)
...
function MAP:AddItemPickups()
	...
	*/
	...
	GAMEMODE:CreateWeaponEntity("weapon_shotgun", Vector(2314.041260, 3420.636230, 28.031250), Angle())
	...
	GAMEMODE:CreatePickupEntity("ammo_9mmclip", Vector(3063.295654, 1447.925171, 144.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_9mmclip", Vector(3081.334473, 1433.287598, 144.031250), Angle())

	GAMEMODE:CreateWeaponEntity("weapon_tripmine", Vector(2282.281738, 1317.875732, 144.031250), Angle())
	...
	GAMEMODE:CreatePickupEntity("ammo_gaussclip", Vector(2433.122803, 1497.718750, 108.031250), Angle())
	...
	GAMEMODE:CreatePickupEntity("ammo_buckshot", Vector(2561.412842, 1493.967773, 108.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_mp5clip", Vector(2539.531738, 1512.920166, 144.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_mp5clip", Vector(2525.281738, 1513.138184, 144.031250), Angle())
	...
	GAMEMODE:CreatePickupEntity("ammo_mp5grenades", Vector(2302.147461, 1006.392944, 144.031250), Angle())
	...
	GAMEMODE:CreateWeaponEntity("weapon_crossbow", Vector(2164.743896, 1872.764648, 332.031250), Angle())
	...
	GAMEMODE:CreateWeaponEntity("weapon_mp5", Vector(4643.636719, 4153.156250, 64.031250), Angle())
	GAMEMODE:CreateWeaponEntity("weapon_shotgun", Vector(4603.160645, 4151.782715, 64.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_buckshot", Vector(4597.372070, 4173.748535, 64.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_buckshot", Vector(4617.163086, 4172.647461, 64.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_mp5clip", Vector(4635.342285, 4173.589844, 64.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_mp5clip", Vector(4652.871094, 4174.498535, 64.031250), Angle())
	GAMEMODE:CreatePickupEntity("ammo_mp5clip", Vector(4643.332031, 4174.003418, 64.031250), Angle())

	GAMEMODE:CreatePickupEntity("item_battery", Vector(3093.693848, 4776.099609, 228.031250), Angle())

	GAMEMODE:CreatePickupEntity("weapon_ak47", Vector(4693.933105, 4185.435547, 140.031250), Angle())
	GAMEMODE:CreatePickupEntity("weapon_sniperrifle", Vector(2873.056396, 4161.054688, 476.031250), Angle())
	...
	GAMEMODE:CreateWeaponEntity("weapon_egon", Vector(2637.772705, 198.270203, 548.031250), Angle())

	// Graves
	GAMEMODE:CreateWeaponEntity("weapon_handgrenade", Vector(4372.219238, 375.280365, 188.031250), Angle())
	GAMEMODE:CreateWeaponEntity("weapon_rpg", Vector(3611.076416, 363.443665, 188.031250), Angle())
	GAMEMODE:CreateWeaponEntity("weapon_gauss", Vector(4392.057129, 7.666440, 188.031250), Angle())
	GAMEMODE:CreateWeaponEntity("weapon_357", Vector(3604.528809, 8.450029, 190.440247), Angle())
	...
	// HERESY
	// add more please
	GAMEMODE:CreateWeaponEntity("weapon_gauss", Vector(4602.375488, 10231.193359, -6531.968750), Angle())

	// Secret Area
	GAMEMODE:CreateWeaponEntity("weapon_handgrenade", Vector(3437.026367, 2434.932861, -383.968750), Angle())
	GAMEMODE:CreateWeaponEntity("weapon_minigun", Vector(2184.070557, 2433.480225, -335.968750), Angle())

//                                                       rotation
//setpos 3175.744629 2983.296387 64.031250;setang 1.998767 -113.410988 0.000000
//setpos 3175.744629 2983.296387 64.031250;setang 1.998767 -65.729874 0.000000
